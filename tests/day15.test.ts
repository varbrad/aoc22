...
Sensor at x=20, y=1: closest beacon is at x=15, y=3`
    ...
    expect(day15.part1(input, 10)).toEqual(26)
  })

  it('should pass input case', () => {
    const input = readDayInput(15)
    expect(day15.part1(input)).toEqual(5394423)
  })
})
...
Sensor at x=20, y=1: closest beacon is at x=15, y=3`
    ...
    expect(day15.part2(input, 20)).toEqual(56000011)
  })

  it('should pass input case', () => {
    const input = readDayInput(15)
    expect(day15.part2(input)).toEqual(11840879211051)
  })
})
